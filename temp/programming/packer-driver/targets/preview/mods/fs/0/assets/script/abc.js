System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Abc", Abc = (_dec = ccclass('Abc'), _dec2 = property(JsonAsset), _dec3 = property(Node), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        ...
        function Abc() {
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "asset", _descriptor, _assertThisInitialized(_this));
        ...
        return Abc;
      }(Component), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "asset", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
